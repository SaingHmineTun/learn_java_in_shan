...
final List<Quiz> csharpQuizM16 = [
  ...
  Quiz(1901, "Exception ပဵၼ်သင်?", ["ပၼ်ႁႃဢၼ်ၵဵတ်းမိူဝ်ႈ App လႅၼ်ႈယူႇ", "ပၼ်ႁႃ Hardware ဢၼ်ၵႄႈဢမ်ႇလႆႈ", "ၵၢၼ်တႅမ်ႈလိၵ်ႈၽိတ်း Syntax", "Memory ၼႂ်းၶွမ်းတဵမ်ပူၼ်ႉတီႈ"], "What is an Exception?"),
  Quiz(1902, "Error လႄႈ Exception ပႅၵ်ႇၵၼ်ၸိူင်ႉႁိုဝ်?", ["Error ၵႄႈဢမ်ႇလႆႈ Exception ၵႄႈလႆႈ", "ပဵၼ်ပၼ်ႁႃဢၼ်မိူၼ်ၵၼ်ၵူႈပိူင်", "Exception ႁၢႆႉၸႃႉလိူဝ် Error", "Error ပဵၼ်လွင်ႈတၢင်းတီႈ Code ၵူၺ်း"], "How do Error and Exception differ?"),
  Quiz(1903, "ပၼ်ႁႃဢၼ်ၵႄႈဢမ်ႇလႆႈ ႁွင်ႉဝႃႈသင်?", ["Error", "Exception", "Warning", "Logic"], "What are unrecoverable problems called?"),
  ...
  Quiz(1905, "OutOfMemoryError ပဵၼ်ပၼ်ႁႃပိူင်လႂ်?", ["Error", "Exception", "Format Error", "User Input Error"], "What type of problem is OutOfMemoryError?"),
  Quiz(1906, "DivideByZeroException ပဵၼ်ပၼ်ႁႃပိူင်လႂ်?", ["Exception", "Hardware Error", "Syntax Error", "Compiler Error"], "What type of problem is DivideByZeroException?"),
  Quiz(1907, "ႁဵတ်းသင်ႁဝ်းၸင်ႇလူဝ်ႇ Exception Handling?", ["တႃႇႁႂ်ႈ App ၶႅင်ၵႅၼ်ႇလႄႈဢမ်ႇလူႉငၢႆႈ", "တႃႇႁဵတ်းႁႂ်ႈ Code လႅၼ်ႈလႆႈဝႆးလိူဝ်", "တႃႇလူတ်ႇ Memory ဢၼ်ဢမ်ႇၸႂ်ႉယဝ်ႉ", "တႃႇႁဵတ်းႁႂ်ႈ Code ယၢဝ်းလိူဝ်ၵဝ်ႇ"], "Why do we need Exception Handling?"),
  Quiz(1908, "သင်ပၼ်ႁႃၵဵတ်းၶိုၼ်းသေႁဝ်းဢမ်ႇႁပ်ႉမိုဝ်းဝႆႉ တေပဵၼ်သင်?", ["App တေ Crash သေပိၵ်ႉၵႂႃႇ", "App တေလႅၼ်ႈဝႆးလိူဝ်ၵဝ်ႇၼမ်", "Compiler တေမႄးပၼ်ႁင်းၵူၺ်း", "ဢမ်ႇပဵၼ်သင်သေယိူင်ႈ"], "What happens if an exception occurs and it's unhandled?"),
  Quiz(1909, "Exception ပဵၼ်လွင်ႈတၢင်းဢၼ်ၵဵတ်းၶိုၼ်းမိူဝ်ႈလႂ်?", ["Runtime", "Compile-time", "Installation", "Designing"], "When do Exceptions occur?"),
  ...
  Quiz(1913, "သင်ၼႂ်း try block မီးပၼ်ႁႃ Code ထႅဝ်တႂ်ႈမၼ်းတေပဵၼ်သင်?", ["တေထုၵ်ႇၶၢမ်ႈပႅတ်ႈသေၵျွၵ်းၵႂႃႇတီႈ catch", "တေသိုပ်ႇလႅၼ်ႈၵႂႃႇၸွမ်းၼင်ႇပိူင်", "တေတႅမ်ႈမႂ်ႇၶိုၼ်းႁင်းၵူၺ်းမၼ်း", "တေလူတ်ႇပႅတ်ႈၶေႃႈမုၼ်းတင်းမူတ်း"], "What happens to the remaining code in a try block after an exception?"),
  Quiz(1914, "Variable 'ex' ၼႂ်း catch(Exception ex) မီးဝႆႉတႃႇသင်?", ["သိမ်းၶေႃႈမုၼ်းပၼ်ႁႃဢၼ်ၵဵတ်းၶိုၼ်း", "ၸႂ်ႉတႃႇပိၵ်ႉ App ၵမ်းလဵဝ်", "ၸႂ်ႉတႃႇပဵၼ်တူဝ်ၼပ်ႉၼႂ်း loop", "ၸႂ်ႉတႃႇႁဵတ်း Loop ၼႂ်း catch"], "What is the variable 'ex' in catch(Exception ex) for?"),
  Quiz(1915, "သင်မီး try ယဝ်ႉ ဢမ်ႇမီး catch ဢမ်ႇၼၼ် finally တေပဵၼ်သင်?", ["Compile Error", "App လႅၼ်ႈလႆႈယူႇၸွမ်းပိူင်", "Code တေဝႆးလိူဝ်ၵဝ်ႇၼမ်", "တေပဵၼ် Warning ၵူၺ်း"], "What happens if there's a try without catch or finally?"),
  Quiz(1916, "ပိူင်သၢင်ႈ try-catch ၸွႆးႁႂ်ႈ App ႁဝ်း _____?", ["ဢမ်ႇ Crash", "မီးသီႁၢင်ႈလီ", "သူင်ႇလိၵ်ႈဝႆး", "ၵဵပ်း Data"], "The try-catch block makes our app _____?"),
  Quiz(1917, "Code ၼႂ်း catch block တေလႅၼ်ႈမိူဝ်ႈလႂ်?", ["မိူဝ်ႈမီး Exception ၼႂ်း try", "လႅၼ်ႈတႃႇသေႇၵူႈပွၵ်ႈ", "ဢမ်ႇလႅၼ်ႈသေပွၵ်ႈၵမ်း", "လႅၼ်ႈမိူဝ်ႈ App ပိၵ်ႉ"], "When does code inside a catch block execute?"),
  Quiz(1918, "C# ၸႂ်ႉ _____ တႃႇသူင်ႇၶေႃႈမုၼ်းပၼ်ႁႃ?", ["Objects", "Strings", "Integers", "Binary"], "What does C# use to send exception information?"),
  Quiz(1919, "သင်ၼႂ်း try block ဢမ်ႇမီးပၼ်ႁႃ catch block တေလႅၼ်ႈႁႃႉ?", ["ဢမ်ႇလႅၼ်ႈ", "လႅၼ်ႈၸွမ်း", "လႅၼ်ႈသွင်ပွၵ်ႈ", "App Error"], "If no exception occurs in try, does the catch block run?"),
  ...
  Quiz(1921, "ႁဵတ်းသင်ႁဝ်းၸင်ႇလူဝ်ႇ Catch Specific Exceptions?", ["တႃႇႁပ်ႉပၼ်ႁႃၸွမ်းၼင်ႇလွင်ႈတၢင်းမၼ်း", "တႃႇႁဵတ်းႁႂ်ႈ Code ယၢဝ်းလိူဝ်", "တႃႇႁဵတ်းႁႂ်ႈ App ၼၵ်းလိူဝ်", "တႃႇႁႂ်ႈ CPU ႁဵတ်းၵၢၼ်ၼမ်"], "Why catch specific exceptions?"),
  ...
  Quiz(1924, "သင်မီး catch လၢႆဢၼ် တူဝ်လႂ်တေလႅၼ်ႈဢွၼ်တၢင်း?", ["တူဝ်ဢၼ်မႅၼ်ႈသေယူႇၽၢႆႇၼိူဝ်", "တူဝ်ဢၼ်ယူႇၽၢႆႇလင်သုတ်း", "လႅၼ်ႈၸွမ်ၵၼ်တင်းမူတ်း", "လႅၼ်ႈလၢႆးၵၢႆႇၵၼ်ၵႂႃႇမႃး"], "If there are multiple catch blocks, which one runs first?"),
  Quiz(1925, "ပၵ်းၵၢၼ်ၵၢၼ်ဝၢင်း catch တေလႆႈဝႆႉၸိူင်ႉႁိုဝ်?", ["Specific ဝႆႉၼိူဝ် General ဝႆႉတႂ်ႈ", "General ဝႆႉၼိူဝ်", "ဝႆႉလၢႆးလႂ်ၵေႃႈလႆႈယူႇ", "ဢမ်ႇလူဝ်ႇမီး General"], "How should catch blocks be ordered?"),
  Quiz(1926, "IndexOutOfRangeException ပဵၼ်မိူဝ်ႈလႂ်?", ["မိူဝ်ႈႁွင်ႉၸႂ်ႉ Index ဢၼ်ဢမ်ႇမီး", "မိူဝ်ႈ Memory RAM တဵမ်", "မိူဝ်ႈ File ၼႂ်းၶွမ်းႁၢႆ", "မိူဝ်ႈ Network လူႉၵႂႃႇ"], "When does IndexOutOfRangeException occur?"),
  Quiz(1927, "NullReferenceException ပဵၼ်မိူဝ်ႈလႂ်?", ["မိူဝ်ႈၸႂ်ႉ Object ဢၼ်ပဵၼ် null", "မိူဝ်ႈႁၢၼ်လူၺ်ႈမၢႆ 0", "မိူဝ်ႈတႅမ်ႈလိၵ်ႈၽိတ်း", "မိူဝ်ႈပိၵ်ႉ App ၵႂႃႇ"], "When does NullReferenceException occur?"),
  Quiz(1928, "သင်ႁဝ်းဝႆႉ catch(Exception ex) ဝႆႉၼိူဝ်သုတ်း တေပဵၼ်သင်?", ["မၼ်းတေႁပ်ႉၵူႈပိူင်သေတူဝ်တႂ်ႈဢမ်ႇလႅၼ်ႈ", "App တေဝႆးလိူဝ်ၵဝ်ႇၼမ်", "Compiler တေၼႄ Warning ၵူၺ်း", "ဢမ်ႇပဵၼ်သင်သေယိူင်ႈ"], "What happens if catch(Exception ex) is placed at the top?"),
  Quiz(1929, "Exception class ဢၼ်ပဵၼ်မႄႈၶွင်ၵူႈတူဝ်ပဵၼ်သင်?", ["System.Exception", "System.Error", "System.Object", "System.Catch"], "What is the base class for all exceptions?"),
  Quiz(1930, "ၸွင်ႇႁဝ်းၸၢင်ႈမီး catch လၢႆဢၼ် ၸွမ်တင်း try တူဝ်လဵဝ်လႆႈႁႃႉ?", ["လႆႈ", "ဢမ်ႇလႆႈ", "လႆႈၵူၺ်း 2 ဢၼ်", "လႆႈၵူၺ်းတူဝ်ၼပ်ႉ"], "Can we have multiple catch blocks for one try?"),

  // Lesson 193: Message and StackTrace
  Quiz(1931, "Property 'Message' မီးဝႆႉတႃႇသင်?", ["တႃႇလၢတ်ႈၼႄဝႃႈပၼ်ႁႃပဵၼ်သင်", "တႃႇၼႄမၢႆထႅဝ်လိၵ်ႈ", "တႃႇပိၵ်ႉ App", "တႃႇသူင်ႇ Email"], "What is the 'Message' property for?"),
  Quiz(1932, "Property 'StackTrace' မီးဝႆႉတႃႇသင်?", ["တႃႇၼႄသဵၼ်ႈတၢင်း လႄႈ မၢႆထႅဝ်လိၵ်ႈ", "တႃႇၼႄၸိုဝ်ႈၵူၼ်းတႅမ်ႈ", "တႃႇမႄး Code ႁင်းၵူၺ်း", "တႃႇသိမ်းၶေႃႈမုၼ်း"], "What is the 'StackTrace' property for?"),
  ...
  Quiz(1934, "ႁဵတ်းသင်ႁဝ်းဢမ်ႇထုၵ်ႇလီၼႄ StackTrace ၸူး User?", ["ယွၼ်ႉမၼ်းဢမ်ႇလွတ်ႈၽေး", "ယွၼ်ႉမၼ်းပဵၼ်သီလမ်", "ယွၼ်ႉမၼ်းႁဵတ်း App ၸႃႉ", "ယွၼ်ႉမၼ်းဢေႇပူၼ်ႉ"], "Why shouldn't we show StackTrace to users?"),
  Quiz(1935, "StackTrace ၼႄၶေႃႈမုၼ်းသင်ပႃး?", ["ၸိုဝ်ႈ Method လႄႈ မၢႆထႅဝ်", "ၸိုဝ်ႈတူဝ် CPU", "မၢႆၾူၼ်းၵူၼ်းၸႂ်ႉ", "Password"], "What information does StackTrace include?"),
  Quiz(1936, "Exception object သိမ်းဝႆႉၼႂ်း Variable လႂ်?", ["ex", "err", "e", "problem"], "In which variable is the exception object usually stored?"),
  Quiz(1937, "Message သူင်ႇၶေႃႈမုၼ်းပဵၼ် Type သင်?", ["string", "int", "bool", "object"], "What type of data does Message return?"),
  Quiz(1938, "သင်ၶႂ်ႈႁူႉဝႃႈပၼ်ႁႃတႄႇပဵၼ်တီႈ File လႂ် တူၺ်းတီႈလႂ်?", ["StackTrace", "Message", "HelpLink", "Data"], "Where do we look to see which file caused the error?"),
  Quiz(1939, "Property 'InnerException' မီးဝႆႉတႃႇသင်?", ["သိမ်းပၼ်ႁႃတူဝ်ၵဝ်ႇဢၼ်ႁေႃႇဝႆႉ", "ၸႂ်ႉတႃႇပိၵ်ႉ App", "ၸႂ်ႉတႃႇလႅၼ်ႈ Code", "ၸႂ်ႉတႃႇႁဵတ်း Loop"], "What is the 'InnerException' property for?"),
  Quiz(1940, "တူဝ် Exception Object ၵဵတ်းၶိုၼ်းမိူဝ်ႈလႂ်?", ["မိူဝ်ႈပၼ်ႁႃၵဵတ်းၶိုၼ်းတႄႉတႄႉ", "မိူဝ်ႈတိုၵ်ႉတႅမ်ႈ Code", "မိူဝ်ႈတႄႇသၢင်ႈ Project", "မိူဝ်ႈပိၵ်ႉၶွမ်းၵႂႃႇ"], "When is the Exception Object created?"),

  // Lesson 194: The 'finally' Block
  Quiz(1941, "Keyword လႂ် တေလႅၼ်ႈ 'တႃႇသေႇ' ဢမ်ႇဝႃႈမီးပၼ်ႁႃ?", ["finally", "catch", "try", "end"], "Which keyword always runs regardless of exceptions?"),
  Quiz(1942, "finally block ၵႆႉၸႂ်ႉတႃႇသင်?", ["တႃႇပိၵ်ႉ Resource", "တႃႇႁပ်ႉပၼ်ႁႃ", "တႃႇၼႄ Message", "တႃႇလႅၼ်ႈပိူင်မႂ်ႇ"], "What is the finally block typically used for?"),
  Quiz(1943, "သင်ၼႂ်း try မီး 'return' ၸွင်ႇ finally တေလႅၼ်ႈႁႃႉ?", ["လႅၼ်ႈဢွၼ်တၢင်း return", "ဢမ်ႇလႅၼ်ႈသေပွၵ်ႈ", "လႅၼ်ႈဝၢႆးလင် return", "App တေ Error"], "Will finally run if there's a 'return' in the try block?"),
  Quiz(1944, "သင်ပၼ်ႁႃၵဵတ်းၼႂ်း catch ၸွင်ႇ finally တေလႅၼ်ႈႁႃႉ?", ["လႅၼ်ႈယူႇ", "ဢမ်ႇလႅၼ်ႈ", "လႅၼ်ႈၵူၺ်းတူဝ်ၼပ်ႉ", "App တေ Crash"], "Will finally run if an exception occurs in the catch block?"),
  Quiz(1945, "ပိူင်သၢင်ႈ 'try-finally' (ဢမ်ႇမီး catch) လႆႈႁႃႉ?", ["လႆႈ", "ဢမ်ႇလႆႈ", "လႆႈၵူၺ်း File", "လႆႈၵူၺ်း C# 12"], "Is a 'try-finally' structure (without catch) valid?"),
  Quiz(1946, "Resource Leak ပဵၼ်သင်?", ["ဢမ်ႇပိၵ်ႉ Resource သေ Memory မူတ်း", "ၵၢၼ်ဢၼ် File ႁၢႆ", "ၵၢၼ်ဢၼ် Network ဝႆး", "ၵၢၼ်ဢၼ် Code ပွတ်း"], "What is a Resource Leak?"),
  Quiz(1947, "ဝၢႆးလင် finally လႅၼ်ႈယဝ်ႉ Code ၽၢႆႇတႂ်ႈတေသိုပ်ႇလႅၼ်ႈႁႃႉ?", ["သိုပ်ႇလႅၼ်ႈယူႇ", "ဢမ်ႇသိုပ်ႇလႅၼ်ႈ", "တႄႇသၢင်ႈ App", "ပိၵ်ႉၶွမ်းၵႂႃႇ"], "Does code after finally continue running?"),
  Quiz(1948, "finally block ဝႆႉတီႈလႂ်?", ["ဝႆႉၽၢႆႇလင် catch တူဝ်လင်သုတ်း", "ဝႆႉၽၢႆႇၼိူဝ် try", "ဝႆႉၽၢႆႇၼႂ်း catch", "ဝႆႉတီႈလႂ်ၵေႃႈလႆႈ"], "Where is the finally block placed?"),
  Quiz(1949, "ၸွင်ႇႁဝ်းၸၢင်ႈမီး finally လၢႆဢၼ်ၸွမ်တင်း try ဢၼ်လဵဝ်?", ["ဢမ်ႇလႆႈ", "လႆႈယူႇ", "လႆႈသင်ပဵၼ် Database", "လႆႈ 3 ဢၼ်"], "Can we have multiple finally blocks for one try?"),
  ...
  Quiz(1952, "ႁဵတ်းသင်ႁဝ်းၸင်ႇလူဝ်ႇ throw exception?", ["တႃႇၵူတ်ႇထတ်းပၵ်းၵၢၼ်", "တႃႇႁဵတ်းႁႂ်ႈ App ၸႃႉ", "တႃႇႁႂ်ႈ CPU တူၵ်း", "တႃႇပိၵ်ႉ Code"], "Why do we throw exceptions?"),
  Quiz(1953, "ArgumentException ၸႂ်ႉတႃႇသင်?", ["မိူဝ်ႈ Parameter ဢမ်ႇမႅၼ်ႈပိူင်", "မိူဝ်ႈ Password ၽိတ်း", "မိူဝ်ႈ Memory တဵမ်", "မိူဝ်ႈ Network လူႉ"], "What is ArgumentException used for?"),
  Quiz(1954, "ဝၢႆးလင် 'throw' ယဝ်ႉ Code ထႅဝ်တႂ်ႈတေပဵၼ်သင်?", ["တေဢမ်ႇလႅၼ်ႈ", "တေသိုပ်ႇလႅၼ်ႈ", "တေလႅၼ်ႈဝႆး", "တေ Error"], "What happens to code after a 'throw' statement?"),
  Quiz(1955, "ၸွင်ႇႁဝ်းၸၢင်ႈ throw Exception ၼႂ်း catch block လႆႈႁႃႉ?", ["လႆႈ", "ဢမ်ႇလႆႈ", "လႆႈၵူၺ်း try", "လႆႈၵူၺ်း static"], "Can we throw an exception inside a catch block?"),
  Quiz(1956, "လၢႆးတႅမ်ႈ 'throw new Exception(\"Error\");' မႅၼ်ႈႁႃႉ?", ["မႅၼ်ႈ", "ၽိတ်း", "လူဝ်ႇ Variable", "ၸႂ်ႉလႆႈၼႂ်း static"], "Is 'throw new Exception(\"Error\");' correct?"),
  Quiz(1957, "Validation ပွင်ႇဝႃႈသင်?", ["ၵၢၼ်ၵူတ်ႇထတ်းၶေႃႈမုၼ်း", "ၵၢၼ်သိမ်းၶေႃႈမုၼ်း", "ၵၢၼ်ပိၵ်ႉ App", "ၵၢၼ်ပိၼ်ႇလိၵ်ႈ"], "What does Validation mean?"),
  Quiz(1958, "သင် throw သေဢမ်ႇမီး try-catch ႁပ်ႉ တေပဵၼ်သင်?", ["App တေ Crash", "App တေသိုပ်ႇလႅၼ်ႈ", "Compiler တေမႄး", "ဢမ်ႇပဵၼ်သင်"], "What happens if we throw an exception without try-catch?"),
  Quiz(1959, "ArgumentNullException ၸႂ်ႉမိူဝ်ႈလႂ်?", ["မိူဝ်ႈ Parameter ပဵၼ် null", "မိူဝ်ႈတူဝ်ၼပ်ႉပဵၼ် 0", "မိူဝ်ႈ Array တဵမ်", "မိူဝ်ႈ File ႁၢႆ"], "When is ArgumentNullException used?"),
  Quiz(1960, "Exception ဢၼ်ႁဝ်း 'throw' ၼၼ်ႉပဵၼ် Type သင်?", ["Object", "String", "Int", "Boolean"], "What type is an exception we 'throw'?"),

  // Lesson 196: Exception Filters
  Quiz(1961, "Keyword လႂ် ၸႂ်ႉတႃႇလိူၵ်ႈႁပ်ႉပၼ်ႁႃၸွမ်းငဝ်းလၢႆး?", ["when", "if", "filter", "check"], "Which keyword is used to filter exceptions based on conditions?"),
  Quiz(1962, "Exception Filter ဝႆႉတီႈလႂ်?", ["ဝႆႉၸွမ်တင်း catch block", "ဝႆႉၽၢႆႇၼႂ်း try", "ဝႆႉၽၢႆႇၼႂ်း finally", "ဝႆႉၽၢႆႇၼိူဝ် method"], "Where is an exception filter placed?"),
  ...
  Quiz(1964, "သင်ငဝ်းလၢႆးၼႂ်း 'when' ပဵၼ် false တေပဵၼ်သင်?", ["catch block ၼၼ်ႉတေထုၵ်ႇၶၢမ်ႈ", "App တေ Error", "လႅၼ်ႈၼႂ်း catch", "လႅၼ်ႈၼႂ်း finally"], "What happens if the 'when' condition is false?"),
  Quiz(1965, "ၽွၼ်းလီၶွင် Exception Filter ပဵၼ်သင်?", ["Code သႅတ်းလႄႈဢမ်ႇလူဝ်ႇ if", "ႁႂ်ႈ App ဝႆး", "ႁႂ်ႈ CPU ၵတ်း", "ႁႂ်ႈ Memory ၼမ်"], "What is the benefit of Exception Filters?"),
  Quiz(1966, "ၸွင်ႇႁဝ်းၸၢင်ႈၸႂ်ႉ Variable ၼွၵ်ႈ try မႃးပဵၼ် filter?", ["လႆႈ", "ဢမ်ႇလႆႈ", "လႆႈၵူၺ်းတူဝ်ၼပ်ႉ", "လႆႈၵူၺ်း C# 9"], "Can we use variables outside the try block as filters?"),
  Quiz(1967, "Exception Filters ၸွႆးႁႄႉၵၢင်ႈလွင်ႈသင်?", ["Stack Unwinding", "Syntax Error", "Memory Leak", "Infinite Loop"], "What does Exception Filters help with regarding the stack?"),
  Quiz(1968, "ႁဝ်းၸၢင်ႈမီး catch လၢႆဢၼ်ဢၼ်ၸႂ်ႉ 'when' တူဝ်လဵဝ်ၵၼ်?", ["လႆႈယူႇ", "ဢမ်ႇလႆႈ", "လႆႈၼႂ်း static", "လႆႈ 2 ဢၼ်"], "Can we have multiple catch blocks using 'when'?"),
  ...
  Quiz(1970, "Filter တေလႆႈသူင်ႇၵႃႈၶၼ်ပဵၼ် Type သင်?", ["bool", "string", "int", "void"], "What type must a filter return?"),
  ...
  Quiz(1972, "လၢႆးတႅမ်ႈ 'throw;' လၢႆလၢႆ ၸွႆးလွင်ႈသင်?", ["ၵဵပ်းသိမ်း StackTrace ဝႆႉ", "လူတ်ႇ StackTrace", "ႁႂ်ႈ App ၵိုတ်း", "ႁႂ်ႈ Code ဝႆး"], "What does 'throw;' (without variable) help with?"),
  Quiz(1973, "သင်ႁဝ်းၸႂ်ႉ 'throw ex;' တေပဵၼ်သင်?", ["StackTrace တေ Reset", "StackTrace တိုၵ်ႉမီးပိုၼ်း", "App တေလႅၼ်ႈဝႆး", "ဢမ်ႇပဵၼ်သင်"], "What happens if we use 'throw ex;'?"),
  Quiz(1974, "လၢႆးလႂ်ဢၼ် 'Best Practice' လိူဝ်?", ["throw;", "throw ex;", "return null;", "break;"], "Which method is best practice for rethrowing?"),
  Quiz(1975, "ႁဵတ်းသင်ႁဝ်းၸင်ႇလူဝ်ႇ Rethrow?", ["မၢႆ Log သေသူင်ႇသိုပ်ႇ", "တႃႇႁႂ်ႈ App Crash", "တႃႇ Memory တဵမ်", "တႃႇ Code ယၢဝ်း"], "Why do we rethrow?"),
  Quiz(1976, "StackTrace Preservation ပွင်ႇဝႃႈသင်?", ["ၵဵပ်းသိမ်းပိုၼ်းပၼ်ႁႃတႄႇပဵၼ်", "ၵၢၼ်လူတ်ႇပႅတ်ႈပိုၼ်း", "ၵၢၼ်မႄး Code", "ၵၢၼ်သၢင်ႈ Object"], "What does StackTrace Preservation mean?"),
  ...
  Quiz(1978, "Rethrowing ၸွႆးလွင်ႈသင်ၼႂ်း App ယႂ်ႇๆ?", ["Centralized Logging", "Fast UI", "Low RAM", "Dark Mode"], "How does rethrowing help in large apps?"),
  Quiz(1979, "Call Stack ပဵၼ်သင်?", ["ၸၼ်ႉၵၢၼ်ႁွင်ႉ Method", "သဵၼ်ႈတၢင်း Network", "တီႈၵဵပ်း File", "ၸိုဝ်ႈ Variable"], "What is a Call Stack?"),
  Quiz(1980, "ၸွင်ႇႁဝ်းၸၢင်ႈမႄး Message ဢွၼ်တၢင်းတေ Rethrow?", ["ဢမ်ႇလႆႈ", "လႆႈယူႇ", "လႆႈၼႂ်း static", "လႆႈၼႂ်း catch"], "Can we modify the Message before rethrowing?"),

  // Lesson 198: Inner Exceptions
  Quiz(1981, "Inner Exception ပဵၼ်သင်?", ["ပၼ်ႁႃၵဝ်ႇဢၼ်ႁေႃႇဝႆႉၼႂ်းတူဝ်မႂ်ႇ", "ပၼ်ႁႃ Hardware", "ပၼ်ႁႃ Network", "ပၼ်ႁႃ Memory"], "What is an Inner Exception?"),
  Quiz(1982, "ႁဵတ်းသင်ႁဝ်းၸင်ႇလူဝ်ႇ Wrap exception?", ["ပၼ်ၶေႃႈမုၼ်းဢၼ်လူငၢႆႈ", "တႃႇႁႂ်ႈ Code ယုင်ႈ", "တႃႇႁႂ်ႈ App ၸႃႉ", "တႃႇႁႂ်ႈ CPU ႁႅင်း"], "Why wrap an exception?"),
  ...
  Quiz(1984, "လၢႆးတႅမ်ႈ 'throw new Exception(\"Msg\", ex);' မႅၼ်ႈႁႃႉ?", ["မႅၼ်ႈ", "ၽိတ်း", "တေလႆႈၸႂ်ႉ out", "တေလႆႈၸႂ်ႉ ref"], "Is 'throw new Exception(\"Msg\", ex);' correct?"),
  Quiz(1985, "Root Cause ပွင်ႇဝႃႈသင်?", ["ငဝ်ႈႁၢၵ်ႈတႄႇဢၼ်ပဵၼ်ပၼ်ႁႃ", "ၸိုဝ်ႈၶွင် App", "မၢႆထႅဝ်လင်သုတ်း", "တူဝ်ၼပ်ႉ"], "What does Root Cause mean?"),
  Quiz(1986, "သင်ဢမ်ႇမီး Inner Exception Property တေပဵၼ်သင်?", ["null", "error", "zero", "empty string"], "What is the InnerException property if there isn't one?"),
  Quiz(1987, "Exception Chaining ပွင်ႇဝႃႈသင်?", ["ၵၢၼ်သၢင်ႈသဵၼ်ႈမၢႆပၼ်ႁႃၵွင်ႉၵၼ်", "ၵၢၼ်ပိၵ်ႉ App", "ၵၢၼ်ႁဵတ်း Loop", "ၵၢၼ်သၢင်ႈ Class"], "What does Exception Chaining mean?"),
  Quiz(1988, "ႁဝ်းၸၢင်ႈ Wrap ပၼ်ႁႃလၢႆၸၼ်ႉလႆႈႁႃႉ?", ["လႆႈ", "ဢမ်ႇလႆႈ", "လႆႈ 2 ၸၼ်ႉ", "လႆႈၼႂ်း Database"], "Can we wrap exceptions multiple levels deep?"),
  Quiz(1989, "Abstraction ၼႂ်း Exception Handling ၸွႆးသင်?", ["ႁႄႉၵၢင်ႈဢမ်ႇႁူႉလွင်ႈ Technical", "ႁႂ်ႈ App ဝႆး", "ႁႂ်ႈ Code လႅင်း", "ႁႂ်ႈ CPU ၼိမ်"], "How does Abstraction help in exception handling?"),
  Quiz(1990, "Constructor လႂ် ၸႂ်ႉတႃႇ Wrap Exception?", ["Exception(string, Exception)", "Exception(string)", "Exception()", "Exception(int)"], "Which constructor is used to wrap an exception?"),

  // Lesson 199: Custom Exceptions
  Quiz(1991, "ႁဝ်းတေလႆႈသိုပ်ႇၸိူဝ်ႉၶိူဝ်းတီႈ Class လႂ်?", ["Exception", "Object", "Error", "System"], "Which class must we inherit from to create a custom exception?"),
  Quiz(1992, "ၸိုဝ်ႈ Class ၶွင် Custom Exception ထုၵ်ႇလီသုတ်းတွၼ်ႈလူၺ်ႈသင်?", ["Exception", "Error", "Problem", "Issue"], "How should a custom exception class name end?"),
  Quiz(1993, "Keyword လႂ် ၸႂ်ႉသူင်ႇ Message ၸူး Constructor?", ["base", "this", "super", "parent"], "Which keyword sends the message to the base Exception class?"),
  Quiz(1994, "ႁဵတ်းသင်ႁဝ်းၸင်ႇလူဝ်ႇ Custom Exception?", ["တႃႇမၵ်းမၼ်ႈပၼ်ႁႃတႅတ်ႉတေႃး", "တႃႇႁႂ်ႈ Code ယုင်ႈ", "တႃႇႁႂ်ႈ App ၼၵ်း", "တႃႇ Compiler ႁဵတ်းၼမ်"], "Why do we need Custom Exceptions?"),
  Quiz(1995, "ၸွင်ႇႁဝ်းၸၢင်ႈသႂ်ႇ Property ႁင်းၵူၺ်းၼႂ်း Custom Exception?", ["လႆႈ", "ဢမ်ႇလႆႈ", "လႆႈၵူၺ်း string", "လႆႈၵူၺ်း int"], "Can we add custom properties to a custom exception?"),
  Quiz(1996, "Serializable ပွင်ႇဝႃႈသင်?", ["ပိၼ်ႇ Object သူင်ႇၽၢၼ်ႇ Network", "ၵၢၼ်ပိၵ်ႉ App", "ၵၢၼ်မႄး Code", "ၵၢၼ်သိုပ်ႇၸိူဝ်ႉၶိူဝ်း"], "What does Serializable mean for an exception?"),
  ...
  Quiz(1998, "ႁဝ်းထုၵ်ႇလီသၢင်ႈ Custom Exception မိူဝ်လႂ်?", ["မိူဝ်ႈ Standard ဢမ်ႇၸႅင်ႈလႅင်း", "သၢင်ႈၵူႈတီႈ", "သၢင်ႈမိူဝ်ႈ App ဝႆး", "ဢမ်ႇသၢင်ႈသေပွၵ်ႈ"], "When should we create a custom exception?"),
  Quiz(1999, "Custom Exception ၸွႆး Developer တၢင်ႇၵေႃႉၸိူင်ႉႁိုဝ်?", ["ႁႂ်ႈၶဝ်ပွင်ႇၸႂ်လွင်ႈတၢင်းၽိတ်းငၢႆႈ", "ႁႂ်ႈၶဝ်တႅမ်ႈ Code ယၢဝ်း", "ႁႂ်ႈၶဝ်ပိၵ်ႉ App", "ဢမ်ႇၸွႆးသင်"], "How does a custom exception help other developers?"),
  Quiz(2000, "ၸၼ်ႉၵၢၼ်သိုပ်ႇၸိူဝ်ႉၶိူဝ်း ၸွႆးလွင်ႈသင်?", ["ႁႂ်ႈမီး Property မိူၼ် Exception", "ႁႂ်ႈ Code ဝႆး", "ႁႂ်ႈ Memory ဢေႇ", "ႁႂ်ႈ CPU ၼိမ်"], "What does inheritance help with in custom exceptions?"),
];
...
final List<Quiz> csharpQuizM18 = [
  ...
  Quiz(2102, "ႁဵတ်းသင်ႁဝ်းၸင်ႇလူဝ်ႇၸႂ်ႉ LINQ တႅၼ်း foreach loop?", ["Code ပွတ်း လႄႈ မႄးငၢႆႈ", "foreach ၸႂ်ႉဢမ်ႇလႆႈယဝ်ႉ", "LINQ ဢမ်ႇၸႂ်ႉ CPU သေဢိတ်း", "LINQ ႁဵတ်းႁႂ်ႈ App ၼၵ်းလိူဝ်"], "Why use LINQ instead of a foreach loop?"),
  Quiz(2103, "LINQ ၸၢင်ႈႁႃၶေႃႈမုၼ်းလုၵ်ႉတီႈလႂ်လႆႈ?", ["Array, List, XML, Database", "String ၵူၺ်း", "Text File ၵူၺ်း", "Internet ၵူၺ်း"], "Where can LINQ query data from?"),
  Quiz(2104, "Declarative Programming ၼႂ်း LINQ ပွင်ႇဝႃႈသင်?", ["လၢတ်ႈဝႃႈ ႁဝ်းၶႂ်ႈလႆႈသင်", "လၢတ်ႈဝႃႈ ႁဵတ်းၸိူင်ႉႁိုဝ်", "ၵၢၼ်ပိတ်း App", "ၵၢၼ်တႅမ်ႈ loop"], "What is Declarative Programming in LINQ?"),
  ...
  Quiz(2106, "LINQ Syntax မီးလၢႆးတႅမ်ႈၵေႃႇပိူင်?", ["2 ပိူင်", "1 ပိူင်", "3 ပိူင်", "4 ပိူင်"], "How many LINQ syntax styles are there?"),
  ...
  Quiz(2111, "IEnumerable<T> ပဵၼ်သင်?", ["Interface ပုၼ်ႈတႃႇပၼ်ႇ loop", "Class သိမ်း Data", "Method တႃႇပိတ်း App", "Database"], "What is IEnumerable<T>?"),
  Quiz(2112, "ႁဵတ်းသင် LINQ ၸင်ႇလူဝ်ႇ IEnumerable?", ["Extension Methods ယူႇတီႈၼၼ်ႉ", "ယွၼ်ႉမၼ်းဝႆး", "ယွၼ်ႉမၼ်းပဵၼ် String", "ယွၼ်ႉမၼ်းပဵၼ် Class"], "Why does LINQ need IEnumerable?"),
  Quiz(2113, "Deferred Execution ၼႂ်း IEnumerable ပွင်ႇဝႃႈသင်?", ["Query တေပႆႇလႅၼ်ႈၵမ်းလဵဝ်", "ၵၢၼ်လႅၼ်ႈၵၢၼ်ၵမ်းလဵဝ်", "ၵၢၼ်ပိတ်း App", "Error"], "What is Deferred Execution in IEnumerable?"),
  Quiz(2114, "လွင်ႈပႅၵ်ႇပိူင်လူင် ၵႄႈ List လႄႈ IEnumerable?", ["IEnumerable ပဵၼ် Read-only", "List ဝႆးလိူဝ်", "IEnumerable ၼၵ်းလိူဝ်", "ဢမ်ႇပႅၵ်ႇသင်"], "Main difference between List and IEnumerable?"),
  Quiz(2115, "Lazy Loading ၼႂ်း LINQ ၸွႆးလွင်ႈသင်?", ["လူတ်းၵၢၼ်ၸႂ်ႉ Memory", "ႁႂ်ႈ App ၼၵ်း", "ႁႂ်ႈ Code ယၢဝ်း", "ႁႂ်ႈ CPU ႁႅင်း"], "How does Lazy Loading help in LINQ?"),

  // Lesson 218: Filtering with Where
  Quiz(2116, "Method '.Where()' ၸႂ်ႉတႃႇသင်?", ["လိူၵ်ႈဢဝ်ၶေႃႈမုၼ်း", "ၸတ်းထႅဝ်", "ပိၼ်ႇ Type", "ၼပ်ႉတၢင်းၼမ်"], "What is the '.Where()' method used for?"),
  Quiz(2117, "Predicate ၼႂ်း Where() တေလႆႈသူင်ႇသင်?", ["bool", "int", "string", "void"], "What value must the predicate in Where() return?"),
  Quiz(2118, "Operator လႂ် ၸႂ်ႉတႃႇၵွင်ႉငဝ်းလၢႆး 'And'?", ["&&", "||", "!", "=="], "Which operator is used for 'And' logic?"),
  Quiz(2119, "Operator လႂ် ၸႂ်ႉတႃႇငဝ်းလၢႆး 'Or'?", ["||", "&&", "!", "=="], "Which operator is used for 'Or' logic?"),
  ...
  Quiz(2121, "Method '.Select()' ၸႂ်ႉတႃႇသင်?", ["ပိၼ်ႇႁၢင်ႈၶေႃႈမုၼ်း", "လိူၵ်ႈထႅဝ်", "ၸတ်းထႅဝ်", "ၼပ်ႉတၢင်းၼမ်"], "What is the '.Select()' method used for?"),
  Quiz(2122, "Projection ၼႂ်း LINQ ပွင်ႇဝႃႈသင်?", ["ၵၢၼ်လႅၵ်ႈပိၼ်ႇႁၢင်ႈ Data", "ၵၢၼ်ပိတ်း App", "ၵၢၼ်သၢင်ႈ Loop", "ၵၢၼ်သူင်ႇ Email"], "What does Projection mean in LINQ?"),
  ...
  Quiz(2124, "ၸွင်ႇႁဝ်းၸၢင်ႈၸႂ်ႉ Select တႃႇ Transform လႆႈႁႃႉ?", ["လႆႈ", "ဢမ်ႇလႆႈ", "လႆႈၵူၺ်း int", "လႆႈၵူၺ်း string"], "Can we use Select for value transformation?"),
  Quiz(2125, "လွင်ႈပႅၵ်ႇပိူင်ၵႄႈ Where လႄႈ Select?", ["Where လိူၵ်ႈထႅဝ် Select လိူၵ်ႈလွၵ်း", "Where ယၢဝ်းလိူဝ်", "Select ဝႆးလိူဝ်", "ဢမ်ႇပႅၵ်ႇသင်"], "Difference between Where and Select?"),

  // Lesson 220: Ordering Data
  Quiz(2126, "Method လႂ် ၸႂ်ႉတႃႇၸတ်းထႅဝ် A-Z?", ["OrderBy", "OrderByDescending", "ThenBy", "Sort"], "Which method sorts A-Z?"),
  Quiz(2127, "Method လႂ် ၸႂ်ႉတႃႇၸတ်း Z-A?", ["OrderByDescending", "OrderBy", "Reverse", "Sort"], "Which method sorts Z-A?"),
  Quiz(2128, "ThenBy ၸႂ်ႉမိူဝ်ႈလႂ်?", ["ၸတ်းထႅဝ်ၸၼ်ႉသွင်", "တႃႇတႄႇၸတ်းထႅဝ်", "တႃႇလိူၵ်ႈထႅဝ်", "တႃႇၼပ်ႉ"], "When is ThenBy used?"),
  Quiz(2129, "ၸွင်ႇႁဝ်းၸၢင်ႈၸႂ်ႉ ThenBy ဢွၼ်တၢင်း OrderBy?", ["ဢမ်ႇလႆႈ", "လႆႈ", "လႆႈၵူၺ်း string", "လႆႈၵူၺ်း int"], "Can we use ThenBy before OrderBy?"),
  Quiz(2130, "Primary Sort ပွင်ႇဝႃႈသင်?", ["ၵၢၼ်ၸတ်းထႅဝ်ၸၼ်ႉတႄႇ", "ၵၢၼ်ၸတ်းထႅဝ်ၸၼ်ႉသွင်", "ၵၢၼ်ပိတ်း App", "ၵၢၼ်သၢင်ႈ Loop"], "What is Primary Sort?"),

  // Lesson 221: Quantifiers
  Quiz(2131, "Method '.Any()' ၸႂ်ႉတႃႇသင်?", ["ၵူတ်ႇထတ်းဝႃႈ မီးမၢင်တူဝ်ႁႃႉ", "ၼပ်ႉတင်းမူတ်း", "ၸတ်းထႅဝ်", "ပိၼ်ႇ Type"], "What is '.Any()' used for?"),
  Quiz(2132, ".All() တေသူင်ႇ True မိူဝ်ႈလႂ်?", ["မိူဝ်ႈၵူႈတူဝ်မႅၼ်ႈၸွမ်း", "မိူဝ်ႈမီး 1 တူဝ်မႅၼ်ႈ", "မိူဝ်ႈဢမ်ႇမီးသင်မႅၼ်ႈ", "မိူဝ်ႈ App Error"], "When does .All() return True?"),
  Quiz(2133, ".Contains() ပႅၵ်ႇတင်း Any() ၸိူင်ႉႁိုဝ်?", ["Contains ႁႃၵႃႈၶၼ်တႅတ်ႉတေႃး", "Any ဝႆးလိူဝ်", "Contains ၼၵ်းလိူဝ်", "ဢမ်ႇပႅၵ်ႇသင်"], "Difference between Contains and Any?"),
  Quiz(2134, "Any() သူင်ႇၵႃႈၶၼ်ပဵၼ်သင်?", ["bool", "int", "string", "List"], "What type does Any() return?"),
  Quiz(2135, "Early Exit ၼႂ်း Any() ပွင်ႇဝႃႈသင်?", ["ၵိုတ်းၵၢၼ်ႁႃမိူဝ်ႈႁၼ်ယဝ်ႉ", "ၵၢၼ်ပိတ်း App", "Error", "Loop"], "What is Early Exit in Any()?"),

  // Lesson 222: Element Operators
  Quiz(2136, ".First() ပႅၵ်ႇတင်း .FirstOrDefault() ၸိူင်ႉႁိုဝ်?", ["FirstOrDefault သူင်ႇ null", "First ဝႆးလိူဝ်", "FirstOrDefault ၼၵ်းလိူဝ်", "ဢမ်ႇပႅၵ်ႇသင်"], "Difference between First and FirstOrDefault?"),
  Quiz(2137, "သင်ႁႃၶေႃႈမုၼ်းႁၼ် 2 တူဝ် .Single() တေပဵၼ်သင်?", ["Exception", "ဢဝ်တူဝ်တႄႇ", "ဢဝ်တူဝ်လင်", "Return null"], "What happens if .Single() finds 2 items?"),
  ...
  Quiz(2140, "SingleOrDefault ၸႂ်ႉတႃႇသင်?", ["ႁႃတူဝ်ဢၼ်မီးတူဝ်လဵဝ်", "ႁႃတူဝ်တႄႇ", "ႁႃတူဝ်လင်", "ၼပ်ႉ"], "What is SingleOrDefault for?"),

  // Lesson 223: Aggregation
  Quiz(2141, "Method '.Count()' ၸႂ်ႉတႃႇသင်?", ["ၼပ်ႉတၢင်းၼမ်", "ႁူမ်ႈၵႃႈၶၼ်", "ႁႃၵႃႈၶၼ်ၵၢင်", "ၸတ်းထႅဝ်"], "What is '.Count()' for?"),
  Quiz(2142, "Method '.Sum()' ၸႂ်ႉတႃႇသင်?", ["ဢဝ်တူဝ်ၼပ်ႉမႃးႁူမ်ႈၵၼ်", "ၼပ်ႉ", "ႁႃၵႃႈၶၼ်ၵၢင်", "ပိတ်း App"], "What is '.Sum()' for?"),
  Quiz(2143, "သင် Average() ၼိူဝ် List ပႅတ်ႈလၢႆ တေပဵၼ်သင်?", ["Exception", "0", "null", "1"], "What happens if Average() is called on an empty list?"),
  Quiz(2144, "Method လႂ် ၸႂ်ႉႁႃၵႃႈၶၼ်ဢေႇသုတ်း?", ["Min", "Max", "Sum", "Average"], "Which method finds the minimum value?"),
  Quiz(2145, "Full Scan ပွင်ႇဝႃႈသင်?", ["ၵၢၼ်လူၶေႃႈမုၼ်းတေႃႇသုတ်း", "ၵၢၼ်ပိတ်း App", "Error", "Loop"], "What is a Full Scan?"),

  // Lesson 224: Grouping Data
  Quiz(2146, "Method '.GroupBy()' ၸႂ်ႉတႃႇသင်?", ["ၸႅၵ်ႇၸုမ်းၶေႃႈမုၼ်း", "ၸတ်းထႅဝ်", "ၼပ်ႉ", "ပိတ်း App"], "What is '.GroupBy()' for?"),
  Quiz(2147, "Key ၼႂ်း GroupBy ပွင်ႇဝႃႈသင်?", ["ၸိုဝ်ႈၸုမ်းတႃႇၸႅၵ်ႇ", "ID လုၵ်ႈႁဵၼ်း", "Password", "Loop"], "What is the Key in GroupBy?"),
  Quiz(2148, "IGrouping<K, T> သိမ်းသင်ဝႆႉ?", ["Key လႄႈ သဵၼ်ႈမၢႆၼႂ်းၸုမ်း", "ID ၵူၺ်း", "Name ၵူၺ်း", "null"], "What does IGrouping store?"),
  Quiz(2149, "တွၼ်ႈတႃႇလူ GroupBy ႁဝ်းၸႂ်ႉ Loop ၸိူင်ႉႁိုဝ်?", ["Nested Foreach", "While loop", "For loop", "ဢမ်ႇၸႂ်ႉ loop"], "How to read GroupBy results?"),
  Quiz(2150, "ၸွင်ႇႁဝ်းၸၢင်ႈၸႂ်ႉ Count() ဝၢႆးလင် GroupBy?", ["လႆႈ", "ဢမ်ႇလႆႈ", "လႆႈၵူၺ်း string", "လႆႈၵူၺ်း int"], "Can we use Count() after GroupBy?"),

  // Lesson 225: Joining Data
  Quiz(2151, "Method '.Join()' ၸႂ်ႉတႃႇသင်?", ["ၵွင်ႉသွင် List ၶဝ်ႈၵၼ်", "ၸတ်းထႅဝ်", "ၼပ်ႉ", "ပိတ်း App"], "What is '.Join()' for?"),
  Quiz(2152, "Inner Join ပွင်ႇဝႃႈသင်?", ["ၼႄၵူၺ်းတူဝ်ဢၼ်မီး Key မိူၼ်ၵၼ်", "ၼႄတင်းမူတ်း", "ၼႄၵူၺ်းၽၢႆႇသၢႆႉ", "Error"], "What is an Inner Join?"),
  Quiz(2153, "Outer List ၼႂ်း Join ပွင်ႇဝႃႈသင်?", ["List တူဝ်တႄႇဢၼ်ႁွင်ႉ Join", "List တူဝ်သွင်", "Database", "Loop"], "What is the Outer List in Join?"),
  Quiz(2154, "Result Selector ၼႂ်း Join ၸႂ်ႉတႃႇသင်?", ["သၢင်ႈပဵၼ် Object မႂ်ႇ", "တႃႇလိူၵ်ႈ ID", "တႃႇၸတ်းထႅဝ်", "တႃႇၼပ်ႉ"], "What is the Result Selector in Join?"),
  ...
  Quiz(2156, "Deferred Execution ၼႂ်း LINQ ၸွႆးသင်?", ["လူတ်း Memory", "ႁႂ်ႈ App ၼၵ်း", "ႁႂ်ႈ Code ယၢဝ်း", "Error"], "Benefit of Deferred Execution?"),
  Quiz(2157, "Method လႂ် ႁဵတ်းႁႂ်ႈ Query လႅၼ်ႈၵမ်းလဵဝ်?", [".ToList()", ".Where()", ".Select()", ".OrderBy()"], "Which method causes immediate execution?"),
  Quiz(2158, "Streaming ၼႂ်း Deferred Execution ပွင်ႇဝႃႈသင်?", ["လူၶေႃႈမုၼ်းၵမ်းတူဝ်", "ၵၢၼ်ပိတ်း App", "Error", "Loop"], "What is Streaming in LINQ?"),
  Quiz(2159, "သင် Add ၶေႃႈမုၼ်း ဝၢႆးသၢင်ႈ Deferred Query မၼ်းတေၼႄႁႃႉ?", ["ၼႄ", "ဢမ်ႇၼႄ", "ၼႄၵူၺ်း string", "ၼႄၵူၺ်း int"], "Will a deferred query see newly added data?"),
  Quiz(2160, "Immediate Execution ပွင်ႇဝႃႈသင်?", ["ၵၢၼ်ႁဵတ်းၵၢၼ်ၵမ်းလဵဝ်", "ၵၢၼ်ယၼ်ႇၶၢဝ်းယၢမ်း", "Error", "Loop"], "What is Immediate Execution?"),

  // Mixed Topics (2161-2200)
  Quiz(2161, "Method Chaining ပွင်ႇဝႃႈသင်?", ["ႁွင်ႉ LINQ သိုပ်ႇၵၼ်ၽၢၼ်ႇတူဝ်မၢႆ", "ၵၢၼ်ပိတ်း App", "ၵၢၼ်သၢင်ႈ Class", "Error"], "What is Method Chaining?"),
  ...
  Quiz(2163, "ၸွင်ႇၸႂ်ႉ Method ႁင်းၵူၺ်း ၼႂ်း Where() လႆႈႁႃႉ?", ["လႆႈ", "ဢမ်ႇလႆႈ", "လႆႈၵူၺ်း string", "လႆႈၵူၺ်း int"], "Can we use custom methods in Where()?"),
  ...
  Quiz(2166, "Method '.OfType<T>()' ၸႂ်ႉတႃႇသင်?", ["လိူၵ်ႈဢဝ်ၵူၺ်း Type ဢၼ်မၵ်းမၼ်ႈ", "ပိၼ်ႇ Type", "ၼပ်ႉ", "ၸတ်းထႅဝ်"], "What is .OfType<T>() for?"),
  Quiz(2167, "ၸွင်ႇ LINQ ၸၢင်ႈမႄး Update ၶေႃႈမုၼ်းၼႂ်း List?", ["ဢမ်ႇလႆႈ", "လႆႈ", "လႆႈၵူၺ်း int", "လႆႈၵူၺ်း string"], "Can LINQ update data in a list?"),
  Quiz(2168, "IOrderedEnumerable<T> လုၵ်ႉတီႈ Method လႂ်?", ["OrderBy", "Where", "Select", "Count"], "Which method returns IOrderedEnumerable<T>?"),
  Quiz(2169, "သင်လူဝ်ႇ 'ၵႃႈၶၼ်ၵၢင်' ႁဝ်းၸႂ်ႉသင်?", ["Average()", "Sum()", "Min()", "Max()"], "How to get the average score?"),
  Quiz(2170, "Method '.Distinct()' ၸႂ်ႉတႃႇသင်?", ["လူတ်ႇၶေႃႈမုၼ်းဢၼ်သမ်ႉဢွၵ်ႇ", "ၼပ်ႉ", "ၸတ်းထႅဝ်", "ပိတ်း App"], "What is .Distinct() for?"),

  Quiz(2171, "Query Execution ပွင်ႇဝႃႈသင်?", ["ယၢမ်းဢၼ် LINQ တႄႇႁႃၶေႃႈမုၼ်း", "ၵၢၼ်တႅမ်ႈ Code", "Error", "Loop"], "What is Query Execution?"),
  Quiz(2172, "ၸွင်ႇၸႂ်ႉ Lambda ၼႂ်း Count() လႆႈႁႃႉ?", ["လႆႈ", "ဢမ်ႇလႆႈ", "လႆႈၵူၺ်း int", "လႆႈၵူၺ်း string"], "Can we use a lambda in Count()?"),
  Quiz(2173, "Method '.Take(n)' ၸႂ်ႉတႃႇသင်?", ["ဢဝ်ၶေႃႈမုၼ်း n တူဝ်ဢွၼ်တၢင်း", "လူတ်ႇ n တူဝ်", "ၸတ်းထႅဝ်", "ၼပ်ႉ"], "What is .Take(n) for?"),
  Quiz(2174, "Method '.Skip(n)' ၸႂ်ႉတႃႇသင်?", ["ၶၢမ်ႇပႅတ်ႈ n တူဝ်ဢွၼ်တၢင်း", "ဢဝ် n တူဝ်", "ၸတ်းထႅဝ်", "ၼပ်ႉ"], "What is .Skip(n) for?"),
  Quiz(2175, "Paging ၵႆႉၸႂ်ႉ Method လႂ်ႁူမ်ႈၵၼ်?", ["Skip() လႄႈ Take()", "Where() လႄႈ Select()", "OrderBy()", "Count()"], "Which methods are used for paging?"),
  Quiz(2176, "LINQ Providers ပွင်ႇဝႃႈသင်?", ["ၶိူင်ႈမိုဝ်းဢၼ်ပိၼ်ႇ LINQ Query", "ၵူၼ်းတႅမ်ႈ Code", "Database", "Loop"], "What are LINQ Providers?"),
  Quiz(2177, "ၸွင်ႇ LINQ ၸၢင်ႈၸႂ်ႉတင်း Dictionary?", ["လႆႈ", "ဢမ်ႇလႆႈ", "လႆႈၵူၺ်း Key", "လႆႈၵူၺ်း Value"], "Can LINQ be used with Dictionary?"),
  Quiz(2178, "Method '.First()' တေသူင်ႇ Type သင်?", ["Type ၶွင် Element", "List", "IEnumerable", "bool"], "What type does .First() return?"),
  Quiz(2179, "သင်လူဝ်ႇႁူႉဝႃႈ List ပႅတ်ႈလၢႆ ၸႂ်ႉသင်ဝႆးသုတ်း?", ["!Any()", "Count() == 0", "FirstOrDefault() == null", "Where().Count()"], "Fastest way to check if a list is empty?"),
  Quiz(2180, "Method '.ElementAt(i)' ၸႂ်ႉတႃႇသင်?", ["ဢဝ်ၶေႃႈမုၼ်းတီႈ Index မၢႆ i", "ၼပ်ႉ", "ၸတ်းထႅဝ်", "ပိၼ်ႇ Type"], "What is .ElementAt(i) for?"),
  Quiz(2181, "ၸွင်ႇႁဝ်းၸၢင်ႈ Join လၢႆလၢႆ List ၸွမ်ၵၼ်?", ["လႆႈ", "ဢမ်ႇလႆႈ", "လႆႈၵူၺ်း 2 List", "လႆႈၵူၺ်း string"], "Can we join multiple lists?"),
  Quiz(2182, "Method Syntax ၵႆႉႁွင်ႉဝႃႈသင်?", ["Method Chaining", "Querying", "Foreaching", "If-Else"], "Method Syntax is often called?"),
  Quiz(2183, "Expression Tree ၼႂ်း LINQ ပွင်ႇဝႃႈသင်?", ["ပိူင်သၢင်ႈ Logic ဢၼ် Compiler ၸႂ်ႉ", "တူၼ်ႈမႆႉ", "Error", "Loop"], "What is an Expression Tree in LINQ?"),
  Quiz(2184, "ၸွင်ႇ .Select() သူင်ႇ Type ဢၼ်ပႅၵ်ႇၵၼ်?", ["လႆႈ", "ဢမ်ႇလႆႈ", "လႆႈၵူၺ်း string", "လႆႈၵူၺ်း int"], "Can .Select() return a different type?"),
  Quiz(2185, "Method '.MinBy()' ၸႂ်ႉတႃႇသင်?", ["ႁႃ Object ဢၼ်မီး Property ဢေႇသုတ်း", "ႁႃ 0", "ၼပ်ႉ", "ၸတ်းထႅဝ်"], "What is .MinBy() for?"),
  Quiz(2186, "ၸွင်ႇ LINQ ႁဵတ်းႁႂ်ႈ Code ဝႆးလိူဝ် foreach loop?", ["ဢမ်ႇ", "ၸိုဝ်ႈ", "ဢမ်ႇႁူႉ", "မႅၼ်ႈ"], "Is LINQ always faster than foreach?"),
  Quiz(2187, "ယိူင်းဢၢၼ်းလူင်ၶွင် LINQ ပဵၼ်သင်?", ["Readability လႄႈ Productivity", "Speed ၵူၺ်း", "Memory ၵူၺ်း", "Security"], "Main goal of LINQ?"),
  Quiz(2188, "Method '.SelectMany()' ၸႂ်ႉတႃႇသင်?", ["Flattening ၶေႃႈမုၼ်း", "ၼပ်ႉ", "ၸတ်းထႅဝ်", "ပိတ်း App"], "What is .SelectMany() for?"),
  Quiz(2189, "ၸွင်ႇႁဝ်းၸၢင်ႈၸႂ်ႉ LINQ ၼႂ်း Unity Engine?", ["လႆႈ", "ဢမ်ႇလႆႈ", "လႆႈၵူၺ်း Android", "လႆႈၵူၺ်း string"], "Can LINQ be used in Unity?"),
  ...
  Quiz(2191, "Method '.Union()' ၸႂ်ႉတႃႇသင်?", ["ႁူမ်ႈသွင် List ၶဝ်ႈၵၼ်", "ၸႅၵ်ႇၸုမ်း", "ၼပ်ႉ", "ပိတ်း App"], "What is .Union() for?"),
  Quiz(2192, "Method '.Intersect()' ၸႂ်ႉတႃႇသင်?", ["ႁႃတူဝ်ဢၼ်မိူၼ်ၵၼ်ၼႂ်းသွင် List", "ႁႃတူဝ်ပႅၵ်ႇ", "ၼပ်ႉ", "ၸတ်းထႅဝ်"], "What is .Intersect() for?"),
  Quiz(2193, "Method '.Except()' ၸႂ်ႉတႃႇသင်?", ["ႁႃတူဝ်ဢၼ်မီးၼႂ်း List ၼိုင်ႈၵူၺ်း", "ႁူမ်ႈ", "ၼပ်ႉ", "ၸတ်းထႅဝ်"], "What is .Except() for?"),
  ...
  Quiz(2195, "Method '.Reverse()' ၸႂ်ႉတႃႇသင်?", ["ပိၼ်ႇသဵၼ်ႈမၢႆလုၵ်ႉလင်မႃးၼႃႈ", "ၼပ်ႉ", "ၸတ်းထႅဝ်", "ပိတ်း App"], "What is .Reverse() for?"),
  Quiz(2196, "ၸွင်ႇ LINQ ၸႂ်ႉတင်း Database ဢမ်ႇၸိုဝ်ႈ SQL?", ["လႆႈ", "ဢမ်ႇလႆႈ", "လႆႈၵူၺ်း Text File", "ဢမ်ႇႁူႉ"], "Can LINQ query non-SQL databases?"),
  Quiz(2197, "Property '.Length' မိူၼ်တင်း Method လႂ်?", ["Count()", "Sum()", "Max()", "Min()"], "Array.Length is equivalent to which LINQ method?"),
  ...
  Quiz(2200, "ၵၢၼ်ႁဵၼ်း LINQ ယဝ်ႉယဝ်ႉ ႁဝ်းႁဵတ်းသင်လႆႈ?", ["ၸတ်းၵၢၼ်ၶေႃႈမုၼ်းငၢႆႈလိူဝ်", "ပိတ်း App", "တႅမ်ႈ HTML", "ဢမ်ႇႁဵတ်းသင်"], "What can we do after learning LINQ?"),
];
