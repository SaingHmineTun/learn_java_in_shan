...
### 3. ၵၢၼ်ၸႂ်ႉတိုဝ်းတႄႉ (Best Practice)
တွၼ်ႈတႃႇ ၸၢႆးမၢဝ်း သွၼ်လုၵ်ႈႁဵၼ်းၼၼ်ႉ လၢတ်ႈလႆႈဝႃႈ:
> **"တႄႇတႅမ်ႈၵမ်းလႂ်ၵေႃႈ ႁႂ်ႈၸႂ်ႉ `let` ဝႆႉဢွၼ်တၢင်း။ ပေႃးမၼ်းတေလႆႈလႅၵ်ႈလၢႆႈတႄႇတႄႇမႃး ၸင်ႇၵွႆလႅၵ်ႈပဵၼ် `var` ၶႃႈ။"**

---

### 4. Immutability inside Collections
