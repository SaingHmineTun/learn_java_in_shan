...
> **"တွၼ်ႈတႃႇ ၸၢႆးမၢဝ်း ႁဵတ်း Keyboard ၼၼ်ႉ: ၸႂ်ႉ `switch` တွၼ်ႈတႃႇၸႅၵ်ႇလွင်ႈၼိပ်ႉ Key ၼႂ်း App။ မိူၼ်ၼင်ႇ ပေႃးၼိပ်ႉ 'Delete', 'Shift', ဢမ်ႇၼၼ် 'Space' ၼႆ ႁဝ်းၸၢင်ႈၸႂ်ႉ `switch` ၸႅၵ်ႇ Case ပၼ်မၼ်း ႁႂ်ႈ Code ႁဝ်းလူငၢႆႈ လႄႈ ၸႅၵ်ႇလႅင်းလီယဝ်ႉ။"**
